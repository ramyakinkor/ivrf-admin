...
export default function AllVideos() {
  ...
  function prepareList(video, index) {
    return (
      <tr>
          ...
          <td className=" p-3 border-[1px] border-slate-300 tracking-wide whitespace-nowrap">
            <div className="flex justify-center">
              <Image height={70} src={video.public}/>
            </div>
          </td>
          <td className="text-center p-3 border-[1px] w-28 border-slate-300 tracking-wide  whitespace-nowrap">
            <div className="flex justify-between items-center gap-2 h-full">
              ...
              <button className="flex gap-1 rounded-[3px] bg-orange-600 py-1 px-2 items-center " onClick={() => dispatch(deleteProduct(video.id))}>
                <FIleIcon height={15} color="white" />
    ...
    <div className="px-10 pt-12 pb-5">
      ...
      <div className="overflow-auto  mt-8 ">
        <table className="min-w-full ">
          ...
          <tbody>
            {videos?.length > 0 && videos.map((video, index) => prepareList(video, index))}
          </tbody>
        </table>
      </div>
